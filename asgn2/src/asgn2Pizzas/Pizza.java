...
public abstract class Pizza  {
	 ...
	 * @throws PizzaException if the quantity of order is more than the maximum amount possible (e.g. 10)
	 * @throws PizzaException if ordered quantity is smaller than minimum amount (e.g. 1)
	...
	public Pizza(int quantity, LocalTime orderTime, LocalTime deliveryTime, String type, double price) throws PizzaException{
		...
		this.throwOut = orderTime.plus(1, ChronoUnit.HOURS);
